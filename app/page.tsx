    ...
    <main className="bg-[#0a0a0a] text-white min-h-screen">
      ...
      <nav className="flex items-center justify-between px-8 py-5 border-b border-white/10 sticky top-0 bg-[#0a0a0a]/90 backdrop-blur-md z-50">
        ...
        <div className="flex gap-3">
          <Link href="/login" className="text-sm px-4 py-2 rounded-lg text-white/70 hover:text-white transition">
            Login
          </Link>
          <Link href="/signup" className="text-sm px-4 py-2 rounded-lg bg-violet-600 hover:bg-violet-500 font-semibold transition">
            Get Started Free
          </Link>
        </div>
      </nav>
      ...
      <section className="flex flex-col items-center text-center px-6 py-32 max-w-5xl mx-auto">
        ...
        <p className="text-white/50 text-lg md:text-xl max-w-2xl mb-10">
          Connect with data analysts, developers, cybersecurity experts and more.
          Find jobs, share datasets, build your career — all in one place.
        </p>
      ...
      <section id="features" className="px-6 py-24 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { icon: "🤖", title: "AI CV Builder", desc: "Generate a world-class CV in seconds. Tailored to your skills and experience automatically." },
            { icon: "💼", title: "Two-Way Job Board", desc: "Companies find you. You find companies. Post your availability or browse thousands of jobs." },
            { icon: "📦", title: "Dataset Library", desc: "Upload, download and share real datasets. CSV, JSON, Excel — all formats supported." },
            { icon: "🏘️", title: "Community Forums", desc: "Join tech-specific channels. Ask questions, share knowledge, grow together." },
            { icon: "📊", title: "Profile Analytics", desc: "See who viewed your profile, track your growth and know your market value." },
            { icon: "🎯", title: "AI Career Coach", desc: "Get AI-powered career advice, skill gap analysis and personalized roadmaps." },
            { icon: "🏆", title: "Gamification", desc: "Earn XP, unlock badges, climb leaderboards. Make your career journey rewarding." },
            { icon: "💬", title: "Direct Messaging", desc: "Connect directly with recruiters, mentors and fellow tech professionals." },
            { icon: "🔒", title: "Verified Profiles", desc: "Stand out with a verified badge. Build trust with recruiters and the community." },
          ].map((f, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
              ...
              <ul className="space-y-3 text-white/50 text-sm mb-8">
                ...
                <li className="text-white/20">✗ Upload datasets</li>
                <li className="text-white/20">✗ Apply to jobs</li>
              </ul>
              <Link href="/signup" className="block text-center py-3 rounded-xl border border-white/20 hover:border-white/50 transition font-semibold">
                Get Started
              </Link>
            </div>
            ...
            <div className="bg-violet-600/20 border border-violet-500 rounded-2xl p-8 relative">
              ...
              <ul className="space-y-3 text-white/70 text-sm mb-8">
                ...
                <li>✓ Upload & download datasets</li>
                <li>✓ Profile analytics</li>
                <li>✓ Verified badge</li>
                <li>✓ Priority in search results</li>
              </ul>
              <Link href="/signup" className="block text-center py-3 rounded-xl bg-violet-600 hover:bg-violet-500 transition font-semibold">
                Start Free Trial
              </Link>
            </div>
